...
<div class="bodyContainer">
    <h1>Add Invoice</h1>
    <p>Fill in the form below to add an Invoice to the selected Contract (RFP).</p>
    <hr>

    <div class="container">
        <form method="POST" controller="contractInvoice" action="save">
            ...
            <input type="hidden" id="contract" name="contract" value="${params.contractID}">
