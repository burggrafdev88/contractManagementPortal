...
<%@ page import="contractmanagementportal.SOWInvoice" contentType="text/html;charset=UTF-8" %>
<html>
<head>
...
<div class="bodyContainer">
    ...
    <div class="container">
        <form method="POST" controller="SOWInvoice" action="../update">
            <!--hidden field for SOWInvoice id-->
            ...
            <div class="row">
                ...
                <div class="col-40">
                    <input type="text" id="invoiceNumber" name="invoiceNumber" class="readOnly" value="${sowInvoice.invoiceNumber}" required readonly>
                </div>
            ...
            <div class="row positionRel">
                ...
                <div class="col-15 removeLeftPadding">
                    <input type="number" id="amount" name="amount" step=".01"
                           pattern="^\\$?(([1-9](\\d*|\\d{0,2}(,\\d{3})*))|0)(\\.\\d{1,2})?$" title="Enter Invoice Amount" class="readOnly" value="${sowInvoice.amount}" required readonly>
                </div>
